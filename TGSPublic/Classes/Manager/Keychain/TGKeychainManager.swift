//
//  TGKeychainManager.swift
//  TGPublicCore
//
//  Created by luo luo on 2021/11/26.
//

import UIKit
import Security

public class TGKeychainManager: NSObject {
    public static let instance :TGKeychainManager = {
           let instance = TGKeychainManager();
           return instance;
       }()
